...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT( \
      KC_TAB,  KC_Q,        KC_W,    KC_E,    KC_R,    KC_T,                         KC_Y,    KC_U,         KC_I,    KC_O,    KC_P,     KC_BSPC, \
      KC_LCTL, CTL_T(KC_A), KC_S,    KC_D,    KC_F,    KC_G,                         KC_H,    CTL_T(KC_J),  KC_K,    KC_L,    KC_SCLN,  KC_ENT, \
      KC_LSFT, KC_Z,        KC_X,    KC_C,    KC_V,    KC_B,                         KC_N,    KC_M,         KC_COMM, KC_DOT,  KC_SLSH,  KC_QUOT, \
      XXXXXXX, XXXXXXX,     XXXXXXX, XXXXXXX, KC_LGUI, SFT_T(KC_SPC), LOWER,  LOWER, KC_LSFT, KC_ESC,       XXXXXXX, XXXXXXX, XXXXXXX,  XXXXXXX\
      ),
  ...
  [_LOWER] = LAYOUT( \
      ...
      _______, _______, _______, _______, _______, _______,                     KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_QUOT, KC_MINS, \
